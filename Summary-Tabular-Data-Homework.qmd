...
This is an evaluation of the sleeping habits of Katherine Nowak. We will sumarize number of hours slept by day of the week. 
...
```{r}
dataWweeks$Hours_Slept <- as.numeric(dataWweeks$Hours_Slept)

summary_data <- dataWweeks %>%
  group_by(dataWweeks$Weeks) %>%
  summarize(dataWweeks$Hours_Slept)
...
The following graph summarizes hours slept by day of the week. We can see the range and mean of the data. 
```{r}
